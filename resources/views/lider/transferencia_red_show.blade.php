...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('lider.transferencia-red.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="modal fade" id="aprobarModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('lider.transferencia-red.aprobar', $solicitud->_id) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="rechazarModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('lider.transferencia-red.rechazar', $solicitud->_id) }}" method="POST">
                    @csrf
