...
<div class="container-fluid">
    ...
    <div class="notif-filter-card fade-in">
        <div class="notif-filter-body">
            <form method="GET" action="{{ route('lider.notificaciones.index') }}">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="notif-icon-wrapper">
                        @switch($notificacion->tipo)
                            ...
                            @case('comision')
                                ...
                                @break
                            @case('meta')
                                <i class="bi bi-target notif-icon" style="color: var(--wine);"></i>
                                @break
                            @case('equipo')
                                <i class="bi bi-people notif-icon" style="color: var(--success);"></i>
                                @break
                            @case('sistema')
...
window.notificacionesRoutes = {
    ...
    marcarTodasLeidas: '{{ route("lider.notificaciones.marcar-todas-leidas") }}',
    eliminar: '{{ route("lider.notificaciones.eliminar", ":id") }}',
    limpiarLeidas: '{{ route("lider.notificaciones.limpiar-leidas") }}',
    crearPruebas: '{{ route("lider.notificaciones.crear-pruebas") }}'
};
