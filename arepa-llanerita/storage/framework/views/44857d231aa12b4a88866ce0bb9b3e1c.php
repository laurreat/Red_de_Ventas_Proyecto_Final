...
<head>
    ...
    <!-- App Theme -->
    <link rel="stylesheet" href="<?php echo e(asset('css/app-theme.css')); ?>">
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Logo" style="height: 40px;" class="me-2">
                        <span class="fw-bold"><?php echo e(config('app.name', 'Arepa la Llanerita')); ?></span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto">
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <?php if(Auth::user()->esAdmin() || Auth::user()->esLider()): ?>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <h6 class="dropdown-header">
                                                ...
                                                <small class="text-muted d-block"><?php echo e(ucfirst(Auth::user()->rol)); ?></small>
                                            </h6>
                                        </li>
                                        ...
                                        <?php if(Auth::user()->tieneReferidos()): ?>
                                            <li>
                                                <a class="dropdown-item" href="#" onclick="showComingSoon('Mis Referidos')">
                                                    <i class="bi bi-people me-2"></i>
                                                    Mis Referidos
                                                    <span class="badge bg-primary ms-2"><?php echo e(Auth::user()->total_referidos); ?></span>
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(Auth::user()->puedeVender()): ?>
                                            <li>
                                                <a class="dropdown-item" href="#" onclick="showComingSoon('Comisiones')">
                                                    ...
                                                    Comisiones
                                                    <?php if(Auth::user()->comisiones_disponibles > 0): ?>
                                                        <span class="badge bg-success ms-2">
                                                            $<?php echo e(number_format(Auth::user()->comisiones_disponibles, 0)); ?>
...
[$__name, $__params] = $__split('toast-notifications');

$__html = app('livewire')->mount($__name, $__params, 'lw-2867770259-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\Proyecto_Final\Red_de_Ventas_Proyecto_Final\arepa-llanerita\resources\views/layouts/app.blade.php ENDPATH**/ ?>