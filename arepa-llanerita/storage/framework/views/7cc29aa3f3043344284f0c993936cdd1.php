...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/cliente-dashboard.css')); ?>">
<?php $__env->stopPush(); ?>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="fw-bold"><?php echo e(auth()->user()->codigo_referido); ?></div>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <div class="card metric-card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="metric-value"><?php echo e(number_format(4)); ?></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-end">
                                            <div>
                                                ...
                                                <div class="fw-bold text-success fs-5">$<?php echo e(format_currency($pedido->total_final)); ?></div>
                                            </div>
            ...
            <div class="card mb-3">
                <div class="card-body text-center" style="background: linear-gradient(135deg, var(--arepa-cream), #f5f0f0); border-radius: 12px; border: 2px solid var(--arepa-light-burgundy);">
                    ...
                    <div class="row text-center mb-3">
                        <div class="col-6">
                            <div class="fw-bold text-success"><?php echo e($stats['referidos_realizados']); ?></div>
...
<script>
    function shareReferralCode() {
        const code = '<?php echo e(auth()->user()->codigo_referido ?? ""); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyecto_Final\Red_de_Ventas_Proyecto_Final\arepa-llanerita\resources\views/dashboard/cliente.blade.php ENDPATH**/ ?>