...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-brand">
                <img src="{{ asset('images/logo.svg') }}" alt="Arepa la Llanerita" class="logo">
            </div>
            ...
            <div class="hero-content">
                ...
                <div class="hero-image">
                    <div class="image-card">
                        <img src="{{ asset('images/arepa-hero.jpg') }}" alt="Arepas Tradicionales" loading="lazy" onerror="this.src='{{ asset('images/logo.svg') }}'">
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-image" data-aos="fade-right">
                    <img src="{{ asset('images/about.jpg') }}" alt="Sobre Nosotros" loading="lazy" onerror="this.src='{{ asset('images/logo.svg') }}'">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <img src="{{ asset('images/logo.svg') }}" alt="Arepa la Llanerita" class="footer-logo">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} Arepa la Llanerita. Todos los derechos reservados.</p>
